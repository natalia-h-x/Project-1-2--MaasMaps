...
public class AbstractedBusNetwork extends BusNetwork {
    ...
    LineFactory.createLine(Color.BLUE, new Point(745, 942), new Point(952, 942), new Point(952, 622), new Point(1112, 622), new Point(1112, 387), new Point(1205, 387), new Point(1205, 466), new Point(1112, 466)),
    LineFactory.createLine(Color.PINK, new Point(745, 942), new Point(773, 947), new Point(773, 1138), new Point(846, 1138), new Point(846, 1201), new Point(988, 1201), new Point(988, 1309)),
    ...
    LineFactory.createLine(Color.MAGENTA, new Point(745, 945), new Point(992, 945), new Point(992, 1309)),
    LineFactory.createLine(Color.PINK, new Point(745, 930), new Point(570, 930), new ControlPoint(521, 930), new Point(521, 971), new Point(521, 1003), new Point(450, 1003), new Point(450, 823), new Point(146, 823), new Point(146, 583), new Point(63, 583)),
    LineFactory.createLine(Color.MAGENTA, new Point(745, 927), new Point(569, 925), new ControlPoint(518, 925), new Point(518, 995), new Point(518, 1000), new Point(454, 1000), new Point(454, 819), new Point(150, 819), new Point(150, 583), new Point(325, 583), new Point(325, 630), new Point(210, 630), new Point(210, 583)),
    LineFactory.createLine(Color.BLUE, new Point(745, 934), new Point(574, 934), new ControlPoint(525, 934), new Point(525, 974), new Point(525, 1008), new Point(52, 1008), new Point(52, 1147), new Point(145, 1147)),
